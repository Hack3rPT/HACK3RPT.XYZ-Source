...
void RenderDefault(IDirect3DDevice9* pDevice)
{
	...
	fDefault = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\piratekeg.ttf", 14.0f);
	fBahn = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\piratekeg.ttf", 14.0f);
	fIcon = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Untitled1.ttf", 21.0f);
