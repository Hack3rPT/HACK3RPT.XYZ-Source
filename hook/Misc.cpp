...
void misc::OnCreateMove(CInput::CUserCmd *cmd, C_BaseEntity *local, bool& bSendPacket)
{
	...
	if (g_Options.Misc.ClantagChanger)
	{
		...
		if (g_Options.Misc.ClantagChanger == 1)
		{
			...
			switch (value) {
			case 0:SetClanTag("hack3rpt.xyz", "skeet"); break;
			case 1:SetClanTag("hack3rpt.xy", "skeet"); break;
			case 2:SetClanTag("hack3rpt.x", "skeet"); break;
			case 3:SetClanTag("hack3rpt.", "skeet"); break;
			case 4:SetClanTag("hack3rpt", "skeet"); break;
			case 5:SetClanTag("hack3rp", "skeet"); break;
			case 6:SetClanTag("hack3r", "skeet"); break;
			case 7:SetClanTag("hack3", "skeet"); break;
			case 8:SetClanTag("hack", "skeet"); break;
			case 9:SetClanTag("hac", "skeet"); break;
			case 10:SetClanTag("ha", "skeet"); break;
			case 11:SetClanTag("h", "skeet"); break;
			case 12:SetClanTag("", "skeet"); break;
			case 13:SetClanTag("hack3rpt.xyz", "skeet"); break;
			case 14:SetClanTag("hack3rpt.xyz", "skeet"); break;
			case 15:SetClanTag("hack3rpt.xyz", "skeet"); break;
		...
		if (g_Options.Misc.ClantagChanger == 2)
		{
			...
			switch (value) {
			case 0:SetClanTag("www.hack3rpt.xyz \r", "skeet"); break;
			case 1:SetClanTag("", "skeet"); break;
		...
		if (g_Options.Misc.ClantagChanger == 3)
		{
			...
			int value = ServerTime % 5;
			switch (value) {
			case 0:SetClanTag("$ hack3rpt.xyz \r", "skeet"); break;
			case 1:SetClanTag("$ \r", "skeet"); break;
		...
		if (g_Options.Misc.ClantagChanger == 4)
		{
			...
			switch (value) {
			case 0:SetClanTag(g_Options.Misc.CustomTag, "skeet"); break;
			case 1:SetClanTag(g_Options.Misc.CustomTag, "skeet"); break;
			case 2:SetClanTag(g_Options.Misc.CustomTag, "skeet"); break;
			}
		}
	}
