...
public:
	...
	float GetInaccuracy() {
		...
		return call_vfunc<tFunc>(this, 468)(this);
	}
...
public:
	...
	void* C_BaseEntity::GetClientRenderable2() {
	...
	void SetAngle2(QAngle wantedang)
	{
		...
		static SetAngleFn SetAngle = (SetAngleFn)((DWORD)GetModuleHandle("client.dll") + offsetz.DT_BasePlayer.m_vecViewOffset);
	...
	bool HasC4()
	{
		int iBombIndex = *(int*)(*(DWORD*)(offsetz.DT_CSPlayerResource.m_iPlayerC4));
