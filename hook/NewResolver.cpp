		...
		else if (g_Options.Ragebot.Resolver == 1)
		{
			...
			else  // very basic stuff. Nowadays everyone uses opposite AAs or close to opposite AAs, soooooooo
			{
				...
				else
				{
					...
					case 7: pEntity->GetEyeAngles()->y = (pEntity->GetLowerBodyYaw() - 90); break;
					case 8: pEntity->GetEyeAngles()->y = (pEntity->GetLowerBodyYaw() + 90); break;
					case 9: pEntity->GetEyeAngles()->y = (pEntity->GetLowerBodyYaw() - 180); break;
					case 10: pEntity->GetEyeAngles()->y = (pEntity->GetLowerBodyYaw() + 180); break;
					}
				}
				/* | cases 6-9 | Effect :25% better | Pasted into all clients cheat | 22/05/2018 | */
			}
